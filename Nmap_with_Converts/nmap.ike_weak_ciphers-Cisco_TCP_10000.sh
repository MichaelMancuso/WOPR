...
ike-scan --trans="(1=1,2=1,3=1,4=1)" -T2 -d 10000 -v $1
echo "Testing DES, SHA1, DH1, PSK..."
ike-scan --trans="(1=1,2=2,3=1,4=1)" -T2 -d 10000 -v $1
echo "Testing DES, MD5, DH2, PSK..."
ike-scan --trans="(1=1,2=1,3=1,4=2)" -T2 -d 10000 -v $1
echo "Testing DES, SHA1, DH2, PSK..."
ike-scan --trans="(1=1,2=2,3=1,4=2)" -T2 -d 10000 -v $1
