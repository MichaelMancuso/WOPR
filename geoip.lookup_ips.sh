...
if [ $# -eq 0 ]; then
	echo "Usage: $0 <IP or csv list>"
	echo "$0 will take each IP address, either a single or comma-separated list and do a geoip and ISP lookup on it."
	echo ""
	exit 1
fi
