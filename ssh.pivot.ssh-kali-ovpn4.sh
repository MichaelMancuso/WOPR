...
if [ -e $HOME/.ssh/mpiscopo_wopr.privatekey ]; then
	ssh.pivot.sh --idfile=$HOME/.ssh/mpiscopo_wopr.privatekey --background --localport=2224 --remoteip=10.8.0.15 --remoteport=22 mpiscopo@$WOPR
else
	ssh.pivot.sh --background --localport=2224 --remoteip=10.8.0.15 --remoteport=22 mpiscopo@$WOPR
fi
