...
if [ -e $HOME/.ssh/mpiscopo_wopr.privatekey ]; then
	ssh.pivot.sh --idfile=$HOME/.ssh/mpiscopo_wopr.privatekey --background --localport=2221 --remoteip=10.8.0.12 --remoteport=22 mpiscopo@$WOPR
else
	ssh.pivot.sh --background --localport=2221 --remoteip=10.8.0.12 --remoteport=22 mpiscopo@$WOPR
fi
